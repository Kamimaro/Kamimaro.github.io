...
calculo.onclick = func_resultado = () => {
    ...
    if (valor_vazao === '' && valor_area !== '' && valor_velocidade !== ''){
        ...
        modal_conteudo.innerHTML = `<p class="palavras"> Considerando os dados inseridos:</p>
                                ...
                                <p class="palavras2"> Velocidade = ${valor_velocidade} m/s </p>
                                <p class="palavras"> Podemos utilizar a fórmula:</p>
                                <p class="palavras2"> A = Q&divideV</p>
                                <p class="palavras"> Para encontrarmos o resultado, substituimos os valores:</p>
                                <p class="palavras2"> A = ${valor_vazao} &divide ${valor_velocidade}</p>
        ...
        modal_conteudo.innerHTML = `<p class="palavras"> Considerando os dados inseridos:</p>
                                ...
                                <p class="palavras"> Podemos utilizar a fórmula:</p>
                                <p class="palavras2"> V = Q&divideA</p>
                                <p class="palavras"> Para encontrarmos o resultado, substituimos os valores:</p>
                                <p class="palavras2"> V = ${valor_vazao} &divide ${valor_area}</p>
        ...
        let vel_final = `${valor_vazao} &divide A`
        let area_final = `${valor_vazao} &divide V`
        modal_conteudo.innerHTML = `<p class="palavras"> Considerando os dados inseridos:</p>
                                <p class="palavras2"> Vazão = ${valor_vazao} m³/s </p>
                                <p class="palavras2"> Área = ? m² </p>
                                <p class="palavras2"> Velocidade = ? m/s </p>
                                <p class="palavras"> Podemos utilizar a fórmula:</p>
                                <p class="palavras2"> V = Q&divideA ou A = Q&divideV</p>
                                <p class="palavras"> Para encontrarmos o resultado, substituimos os valores:</p>
        ...
        let vel_final = `Q &divide ${valor_area}`
        ...
        modal_conteudo.innerHTML = `<p class="palavras"> Considerando os dados inseridos:</p>
                                ...
                                <p class="palavras2"> Velocidade = ? m/s </p>
                                <p class="palavras"> Podemos utilizar a fórmula:</p>
                                <p class="palavras2"> Q = V.A ou V = Q&divideA</p>
                                <p class="palavras"> Para encontrarmos o resultado, substituimos os valores:</p>
        ...
        let area_final = `Q &divide ${valor_velocidade}`
        ...
        modal_conteudo.innerHTML = `<p class="palavras"> Considerando os dados inseridos:</p>
                                ...
                                <p class="palavras2"> Velocidade = ${valor_velocidade} m/s </p>
                                <p class="palavras"> Podemos utilizar a fórmula:</p>
                                <p class="palavras2"> Q = V.A ou A = Q&divideV</p>
                                <p class="palavras"> Para encontrarmos o resultado, substituimos os valores:</p>
